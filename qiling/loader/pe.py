...
class Process:
    ...
    def init_se_exports(self):
        ...
        self.ql.mem.map(SeExports, self.ql.mem.align_up(SeExports_size), info='[SeExports]')
...
class QlLoaderPE(QlLoader, Process):
    ...
    def load(self, pe: Optional[pefile.PE]):
        ...
        if pe is not None:
            ...
            # This should be called after imports initialization, because it uses one of the imports
            if self.is_driver:

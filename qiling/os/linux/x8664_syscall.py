...
X8664_LINUX_SYSCALL_NANOSLEEP         = [0x23, "ql_syscall_nanosleep" ]
X8664_LINUX_SYSCALL_SOCKET            = [0x29, "ql_syscall_socket" ]
X8664_LINUX_SYSCALL_SETSOCKOPT        = [0x36, "ql_syscall_setsockopt" ]
X8664_LINUX_SYSCALL_BIND              = [0x31, "ql_syscall_bind" ]
X8664_LINUX_SYSCALL_LISTEN            = [0x32, "ql_syscall_listen" ]
X8664_LINUX_SYSCALL_ACCEPT            = [0x2b, "ql_syscall_accept" ]
X8664_LINUX_SYSCALL_CLONE             = [0x38, "ql_syscall_clone" ]
...
X8664_LINUX_SYSCALL = [
    ...
    X8664_LINUX_SYSCALL_NANOSLEEP,
    X8664_LINUX_SYSCALL_SOCKET,
    X8664_LINUX_SYSCALL_SETSOCKOPT,
    X8664_LINUX_SYSCALL_BIND,
    X8664_LINUX_SYSCALL_LISTEN,
    X8664_LINUX_SYSCALL_ACCEPT,
    X8664_LINUX_SYSCALL_CLONE
    ]
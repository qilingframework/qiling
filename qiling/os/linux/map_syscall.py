...
def get_syscall_mapper(archtype: QL_ARCH):
    syscall_table = {
        ...
        QL_ARCH.MIPS64  : mips64_n64_syscall_table,
...
# MIPS64 n64 ABI (syscall base 5000), generated from the Linux kernel uapi
# header asm/unistd_n64.h
mips64_n64_syscall_table = {
    5000: "read",
    5001: "write",
    5002: "open",
    5003: "close",
    ...
    5327: "rseq",
    5328: "io_pgetevents",
    5424: "pidfd_send_signal",
    5425: "io_uring_setup",
    5426: "io_uring_enter",
    5427: "io_uring_register",
    5428: "open_tree",
    5429: "move_mount",
    5430: "fsopen",
    5431: "fsconfig",
    ...
    5438: "pidfd_getfd",
    5439: "faccessat2",
    5440: "process_madvise",
    5441: "epoll_pwait2",
    5442: "mount_setattr",
    5443: "quotactl_fd",
    5444: "landlock_create_ruleset",
    5445: "landlock_add_rule",
    5446: "landlock_restrict_self",
    5448: "process_mrelease",
    5449: "futex_waitv",
    5450: "set_mempolicy_home_node",
    5451: "cachestat",
    5452: "fchmodat2",
    5453: "map_shadow_stack",
    5454: "futex_wake",
    5455: "futex_wait",
    5456: "futex_requeue",
    5457: "statmount",
    5458: "listmount",
    5459: "lsm_get_self_attr",
    5460: "lsm_set_self_attr",
    5461: "lsm_list_modules",
}

...
EFI_ADD_MEMORY_SPACE = FUNCPTR(
    EFI_STATUS, EFI_GCD_MEMORY_TYPE, EFI_PHYSICAL_ADDRESS, UINT64, UINT64
)
EFI_ALLOCATE_MEMORY_SPACE = FUNCPTR(
    EFI_STATUS,
...
EFI_GET_MEMORY_SPACE_DESCRIPTOR = FUNCPTR(
    EFI_STATUS, EFI_PHYSICAL_ADDRESS, PTR(EFI_GCD_MEMORY_SPACE_DESCRIPTOR)
)
EFI_SET_MEMORY_SPACE_ATTRIBUTES = FUNCPTR(
    EFI_STATUS, EFI_PHYSICAL_ADDRESS, UINT64, UINT64
)
EFI_GET_MEMORY_SPACE_MAP = FUNCPTR(
    EFI_STATUS, PTR(UINTN), PTR(PTR(EFI_GCD_MEMORY_SPACE_DESCRIPTOR))
)
EFI_ADD_IO_SPACE = FUNCPTR(
    EFI_STATUS, EFI_GCD_IO_TYPE, EFI_PHYSICAL_ADDRESS, UINT64
)
EFI_ALLOCATE_IO_SPACE = FUNCPTR(
    EFI_STATUS,
    EFI_GCD_ALLOCATE_TYPE,
    EFI_GCD_IO_TYPE,
    UINTN,
...
EFI_GET_IO_SPACE_DESCRIPTOR = FUNCPTR(
    EFI_STATUS, EFI_PHYSICAL_ADDRESS, PTR(EFI_GCD_IO_SPACE_DESCRIPTOR)
)
EFI_GET_IO_SPACE_MAP = FUNCPTR(
    EFI_STATUS, PTR(UINTN), PTR(PTR(EFI_GCD_IO_SPACE_DESCRIPTOR))
)
...
EFI_PROCESS_FIRMWARE_VOLUME = FUNCPTR(
    EFI_STATUS, PTR(VOID), UINTN, PTR(EFI_HANDLE)
)
EFI_SET_MEMORY_SPACE_CAPABILITIES = FUNCPTR(
    EFI_STATUS, EFI_PHYSICAL_ADDRESS, UINT64, UINT64
)
...
__all__ = ["EFI_DXE_SERVICES", "initialize"]

...
struct_EFI_FIRMWARE_VOLUME2_PROTOCOL._fields_ = [
    ('GetVolumeAttributes', POINTER_T(None)),
    ('SetVolumeAttributes', POINTER_T(None)),
    ('ReadFile', POINTER_T(None)),
    ('ReadSection', POINTER_T(None)),
    ('WriteFile', POINTER_T(None)),
    ('GetNextFile', POINTER_T(None)),
    ('KeySize', ctypes.c_uint32),
    ('ParentHandle', EFI_HANDLE),
    ('GetInfo', POINTER_T(None)),
    ('SetInfo', POINTER_T(None)),
]

EFI_FIRMWARE_VOLUME2_PROTOCOL = struct_EFI_FIRMWARE_VOLUME2_PROTOCOL
PEFI_FIRMWARE_VOLUME2_PROTOCOL = POINTER_T(struct_EFI_FIRMWARE_VOLUME2_PROTOCOL)
...
__all__ = \
    ...
    'EFI_OPEN_PROTOCOL_INFORMATION', 'EFI_LOADED_IMAGE_PROTOCOL', 'EFI_FIRMWARE_VOLUME2_PROTOCOL',
    ...
    'PEFI_LOADED_IMAGE_PROTOCOL', 'PEFI_FIRMWARE_VOLUME2_PROTOCOL', 'PGUID',
    ...
    'struct_EFI_RUNTIME_SERVICES', 'struct_EFI_LOADED_IMAGE_PROTOCOL', 'struct_EFI_FIRMWARE_VOLUME2_PROTOCOL',

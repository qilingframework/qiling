...
P_EFI_HII_AIBT_CLEAR_IMAGES_BLOCK = POINTER_T(
...
P_EFI_HII_AIBT_OVERLAY_IMAGES_BLOCK = POINTER_T(
...
P_EFI_HII_AIBT_RESTORE_SCRN_BLOCK = POINTER_T(
...
P_EFI_HII_ANIMATION_PACKAGE_HDR = POINTER_T(
...
P_EFI_HII_DEVICE_PATH_PACKAGE_HDR = POINTER_T(
...
P_EFI_HII_GIBT_GLYPH_DEFAULT_BLOCK = POINTER_T(
...
P_EFI_HII_GIBT_GLYPHS_DEFAULT_BLOCK = POINTER_T(
...
P_EFI_HII_IIBT_IMAGE_1BIT_BLOCK = POINTER_T(
...
P_EFI_HII_IIBT_IMAGE_1BIT_TRANS_BLOCK = POINTER_T(
    struct__EFI_HII_IIBT_IMAGE_1BIT_TRANS_BLOCK
)
...
P_EFI_HII_IIBT_IMAGE_24BIT_BASE = POINTER_T(
...
P_EFI_HII_IIBT_IMAGE_24BIT_BLOCK = POINTER_T(
...
P_EFI_HII_IIBT_IMAGE_24BIT_TRANS_BLOCK = POINTER_T(
    struct__EFI_HII_IIBT_IMAGE_24BIT_TRANS_BLOCK
)
...
P_EFI_HII_IIBT_IMAGE_4BIT_BLOCK = POINTER_T(
...
P_EFI_HII_IIBT_IMAGE_4BIT_TRANS_BLOCK = POINTER_T(
    struct__EFI_HII_IIBT_IMAGE_4BIT_TRANS_BLOCK
)
...
P_EFI_HII_IIBT_IMAGE_8BIT_PALETTE_BLOCK = POINTER_T(
    struct__EFI_HII_IIBT_IMAGE_8BIT_PALETTE_BLOCK
)
...
P_EFI_HII_IIBT_IMAGE_8BIT_TRANS_BLOCK = POINTER_T(
    struct__EFI_HII_IIBT_IMAGE_8BIT_TRANS_BLOCK
)
...
P_EFI_HII_IMAGE_PALETTE_INFO_HEADER = POINTER_T(
...
P_EFI_HII_SIBT_STRING_SCSU_BLOCK = POINTER_T(
...
P_EFI_HII_SIBT_STRING_SCSU_FONT_BLOCK = POINTER_T(
    struct__EFI_HII_SIBT_STRING_SCSU_FONT_BLOCK
)
...
P_EFI_HII_SIBT_STRING_UCS2_BLOCK = POINTER_T(
...
P_EFI_HII_SIBT_STRING_UCS2_FONT_BLOCK = POINTER_T(
    struct__EFI_HII_SIBT_STRING_UCS2_FONT_BLOCK
)
...
P_EFI_HII_SIBT_STRINGS_SCSU_BLOCK = POINTER_T(
...
P_EFI_HII_SIBT_STRINGS_SCSU_FONT_BLOCK = POINTER_T(
    struct__EFI_HII_SIBT_STRINGS_SCSU_FONT_BLOCK
)
...
P_EFI_HII_SIBT_STRINGS_UCS2_BLOCK = POINTER_T(
...
P_EFI_HII_SIBT_STRINGS_UCS2_FONT_BLOCK = POINTER_T(
    struct__EFI_HII_SIBT_STRINGS_UCS2_FONT_BLOCK
)
...
P_EFI_HII_SIMPLE_FONT_PACKAGE_HDR = POINTER_T(
...
Ps_pxe_cpb_fill_header_fragmented = POINTER_T(
...
EFI_ALLOCATE_POOL = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, enum_13, ctypes.c_uint64, POINTER_T(POINTER_T(None))
    )
)
...
struct_EFI_BOOT_SERVICES._fields_ = [
    ...
    (
        "FreePages",
        POINTER_T(
            ctypes.CFUNCTYPE(ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64)
        ),
    ),
    (
        "GetMemoryMap",
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(ctypes.c_uint64),
                POINTER_T(struct_EFI_MEMORY_DESCRIPTOR),
                POINTER_T(ctypes.c_uint64),
                POINTER_T(ctypes.c_uint64),
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ...
                ctypes.c_uint64,
                POINTER_T(
                    ctypes.CFUNCTYPE(None, POINTER_T(None), POINTER_T(None))
                ),
                POINTER_T(None),
                POINTER_T(POINTER_T(None)),
            )
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64, POINTER_T(None), enum_71, ctypes.c_uint64
            )
        ),
    ),
    (
    ...
    (
        "SignalEvent",
        POINTER_T(ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None))),
    ),
    (
        "CloseEvent",
        POINTER_T(ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None))),
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(struct_GUID),
                POINTER_T(POINTER_T(struct_EFI_DEVICE_PATH_PROTOCOL)),
                POINTER_T(POINTER_T(None)),
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64, POINTER_T(struct_GUID), POINTER_T(None)
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ...
                ctypes.c_ubyte,
                POINTER_T(None),
                POINTER_T(struct_EFI_DEVICE_PATH_PROTOCOL),
                POINTER_T(None),
                ctypes.c_uint64,
                POINTER_T(POINTER_T(None)),
            )
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ...
                POINTER_T(None),
                POINTER_T(ctypes.c_uint64),
                POINTER_T(POINTER_T(ctypes.c_uint16)),
            )
        ),
    ),
    (
    ...
    (
        "ExitBootServices",
        POINTER_T(
            ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None), ctypes.c_uint64)
        ),
    ),
    (
        "GetNextMonotonicCount",
        POINTER_T(
            ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(ctypes.c_uint64))
        ),
    ),
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ...
                POINTER_T(struct_GUID),
                POINTER_T(
                    POINTER_T(struct_EFI_OPEN_PROTOCOL_INFORMATION_ENTRY)
                ),
                POINTER_T(ctypes.c_uint64),
            )
        ),
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(None),
                POINTER_T(POINTER_T(POINTER_T(struct_GUID))),
                POINTER_T(ctypes.c_uint64),
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ...
                POINTER_T(None),
                POINTER_T(ctypes.c_uint64),
                POINTER_T(POINTER_T(POINTER_T(None))),
            )
        ),
    ),
    (
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(POINTER_T(None)))
        ),
    ),
    (
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                None, POINTER_T(None), POINTER_T(None), ctypes.c_uint64
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                None, POINTER_T(None), ctypes.c_uint64, ctypes.c_ubyte
            )
        ),
    ),
    (
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("RaiseTPL", ["ctypes.c_uint64", "ctypes.c_uint64"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    ("RestoreTPL", ["None", "ctypes.c_uint64"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "AllocatePages",
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("FreePages", ["ctypes.c_uint64", "ctypes.c_uint64", "ctypes.c_uint64"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "GetMemoryMap",
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("FreePool", ["ctypes.c_uint64", "POINTER_T(None)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "CreateEvent",
        [
            ...
            "ctypes.c_uint32",
            "ctypes.c_uint64",
            "POINTER_T(ctypes.CFUNCTYPE(None, POINTER_T(None), POINTER_T(None)))",
            "POINTER_T(None)",
            "POINTER_T(POINTER_T(None))",
        ],
    )
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("SignalEvent", ["ctypes.c_uint64", "POINTER_T(None)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    ("CloseEvent", ["ctypes.c_uint64", "POINTER_T(None)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    ("CheckEvent", ["ctypes.c_uint64", "POINTER_T(None)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "InstallProtocolInterface",
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("UnloadImage", ["ctypes.c_uint64", "POINTER_T(None)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "ExitBootServices",
        ["ctypes.c_uint64", "POINTER_T(None)", "ctypes.c_uint64"],
    )
)
struct_EFI_BOOT_SERVICES._functions_.append(
    ("GetNextMonotonicCount", ["ctypes.c_uint64", "POINTER_T(ctypes.c_uint64)"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    ("Stall", ["ctypes.c_uint64", "ctypes.c_uint64"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "SetWatchdogTimer",
...
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        ...
        [
            ...
            "POINTER_T(None)",
            "POINTER_T(struct_GUID)",
            "POINTER_T(POINTER_T(struct_EFI_OPEN_PROTOCOL_INFORMATION_ENTRY))",
            "POINTER_T(ctypes.c_uint64)",
        ],
    )
)
...
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "InstallMultipleProtocolInterfaces",
        ["ctypes.c_uint64", "POINTER_T(POINTER_T(None))"],
    )
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "UninstallMultipleProtocolInterfaces",
        ["ctypes.c_uint64", "POINTER_T(None)"],
    )
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
...
struct_EFI_BOOT_SERVICES._functions_.append(
    ("SetMem", ["None", "POINTER_T(None)", "ctypes.c_uint64", "ctypes.c_ubyte"])
)
struct_EFI_BOOT_SERVICES._functions_.append(
    (
        "CreateEventEx",
...
EFI_EVENT_NOTIFY = POINTER_T(
    ctypes.CFUNCTYPE(None, POINTER_T(None), POINTER_T(None))
)
EFI_CREATE_EVENT = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint32,
        ctypes.c_uint64,
...
EFI_SET_TIMER = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None), enum_71, ctypes.c_uint64)
)
EFI_WAIT_FOR_EVENT = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint64,
        POINTER_T(POINTER_T(None)),
...
EFI_INSTALL_PROTOCOL_INTERFACE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(POINTER_T(None)),
        POINTER_T(struct_GUID),
...
EFI_REINSTALL_PROTOCOL_INTERFACE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(struct_GUID),
...
EFI_UNINSTALL_PROTOCOL_INTERFACE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(struct_GUID),
...
EFI_REGISTER_PROTOCOL_NOTIFY = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct_GUID),
        POINTER_T(None),
...
EFI_LOCATE_DEVICE_PATH = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct_GUID),
        POINTER_T(POINTER_T(struct_EFI_DEVICE_PATH_PROTOCOL)),
...
EFI_INSTALL_CONFIGURATION_TABLE = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(struct_GUID), POINTER_T(None))
)
EFI_IMAGE_LOAD = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_ubyte,
        POINTER_T(None),
...
EFI_EXIT_BOOT_SERVICES = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None), ctypes.c_uint64)
)
EFI_GET_NEXT_MONOTONIC_COUNT = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(ctypes.c_uint64))
)
EFI_STALL = POINTER_T(ctypes.CFUNCTYPE(ctypes.c_uint64, ctypes.c_uint64))
EFI_SET_WATCHDOG_TIMER = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint64,
        ctypes.c_uint64,
...
EFI_CONNECT_CONTROLLER = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(POINTER_T(None)),
...
EFI_DISCONNECT_CONTROLLER = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, POINTER_T(None), POINTER_T(None), POINTER_T(None)
    )
)
EFI_OPEN_PROTOCOL = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(struct_GUID),
...
PEFI_OPEN_PROTOCOL_INFORMATION_ENTRY = POINTER_T(
    struct_EFI_OPEN_PROTOCOL_INFORMATION_ENTRY
)
EFI_OPEN_PROTOCOL_INFORMATION = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(struct_GUID),
...
EFI_PROTOCOLS_PER_HANDLE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        POINTER_T(POINTER_T(POINTER_T(struct_GUID))),
...
EFI_LOCATE_HANDLE_BUFFER = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        enum_76,
        POINTER_T(struct_GUID),
...
EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACES = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(POINTER_T(None)))
)
EFI_UNINSTALL_MULTIPLE_PROTOCOL_INTERFACES = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(None))
)
EFI_CALCULATE_CRC32 = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(None),
        ctypes.c_uint64,
...
EFI_COPY_MEM = POINTER_T(
    ctypes.CFUNCTYPE(None, POINTER_T(None), POINTER_T(None), ctypes.c_uint64)
)
EFI_SET_MEM = POINTER_T(
    ctypes.CFUNCTYPE(None, POINTER_T(None), ctypes.c_uint64, ctypes.c_ubyte)
)
EFI_CREATE_EVENT_EX = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint32,
        ctypes.c_uint64,
...
EFI_CONVERT_POINTER = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, ctypes.c_uint64, POINTER_T(POINTER_T(None))
    )
)
EFI_GET_NEXT_HIGH_MONO_COUNT = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(ctypes.c_uint32))
)
EFI_GET_NEXT_VARIABLE_NAME = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(ctypes.c_uint64),
        POINTER_T(ctypes.c_uint16),
...
EFI_GET_TIME = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct_EFI_TIME),
        POINTER_T(struct_EFI_TIME_CAPABILITIES),
    )
)
EFI_GET_VARIABLE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(ctypes.c_uint16),
        POINTER_T(struct_GUID),
...
struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL._fields_ = [
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL),
                ctypes.c_ubyte,
            )
        ),
    ),
...
struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL._functions_.append(
    (
        "Reset",
        [
            "ctypes.c_uint64",
...
struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL._fields_ = [
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL),
                ctypes.c_ubyte,
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL),
                POINTER_T(struct_EFI_INPUT_KEY),
            )
        ),
    ),
...
struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL._functions_.append(
    (
        "Reset",
        [
            "ctypes.c_uint64",
...
struct_EFI_RUNTIME_SERVICES._fields_ = [
    ...
    (
        "SetTime",
        POINTER_T(
            ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(struct_EFI_TIME))
        ),
    ),
    (
        "GetWakeupTime",
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64, ctypes.c_ubyte, POINTER_T(struct_EFI_TIME)
            )
        ),
    ),
    (
    ...
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                None, enum_73, ctypes.c_uint64, ctypes.c_uint64, POINTER_T(None)
            )
        ),
    ),
    (
        ...
        POINTER_T(
            ctypes.CFUNCTYPE(
                ctypes.c_uint64,
                POINTER_T(POINTER_T(struct_EFI_CAPSULE_HEADER)),
                ctypes.c_uint64,
                ctypes.c_uint64,
            )
        ),
...
struct_EFI_RUNTIME_SERVICES._functions_.append(
    (
        "GetTime",
        [
            "ctypes.c_uint64",
...
struct_EFI_RUNTIME_SERVICES._functions_.append(
    ("SetTime", ["ctypes.c_uint64", "POINTER_T(struct_EFI_TIME)"])
)
struct_EFI_RUNTIME_SERVICES._functions_.append(
    (
        "GetWakeupTime",
...
struct_EFI_RUNTIME_SERVICES._functions_.append(
    (
        "GetNextHighMonotonicCount",
        ["ctypes.c_uint64", "POINTER_T(ctypes.c_uint32)"],
    )
)
struct_EFI_RUNTIME_SERVICES._functions_.append(
    (
...
EFI_IMAGE_ENTRY_POINT = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, POINTER_T(None), POINTER_T(struct_EFI_SYSTEM_TABLE)
    )
)
_EFI_SIMPLE_TEXT_INPUT_PROTOCOL = struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL
P_EFI_SIMPLE_TEXT_INPUT_PROTOCOL = POINTER_T(
    struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL
)
EFI_SIMPLE_TEXT_INPUT_PROTOCOL = struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL
P_EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL = POINTER_T(
    struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL
)
...
EFI_TEXT_TEST_STRING = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL),
        POINTER_T(ctypes.c_uint16),
...
EFI_TEXT_SET_ATTRIBUTE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL),
        ctypes.c_uint64,
...
EFI_TEXT_CLEAR_SCREEN = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL)
    )
)
EFI_TEXT_SET_CURSOR_POSITION = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL),
        ctypes.c_uint64,
...
EFI_TEXT_ENABLE_CURSOR = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL),
        ctypes.c_ubyte,
...
EFI_SET_TIME = POINTER_T(
    ctypes.CFUNCTYPE(ctypes.c_uint64, POINTER_T(struct_EFI_TIME))
)
EFI_SET_WAKEUP_TIME = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64, ctypes.c_ubyte, POINTER_T(struct_EFI_TIME)
    )
)
EFI_SET_VIRTUAL_ADDRESS_MAP = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint64,
        ctypes.c_uint64,
...
EFI_RESET_SYSTEM = POINTER_T(
    ctypes.CFUNCTYPE(
        None, enum_73, ctypes.c_uint64, ctypes.c_uint64, POINTER_T(None)
    )
)
EFI_UPDATE_CAPSULE = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(POINTER_T(struct_EFI_CAPSULE_HEADER)),
        ctypes.c_uint64,
...
EFI_QUERY_CAPSULE_CAPABILITIES = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        POINTER_T(POINTER_T(struct_EFI_CAPSULE_HEADER)),
        ctypes.c_uint64,
...
EFI_QUERY_VARIABLE_INFO = POINTER_T(
    ctypes.CFUNCTYPE(
        ctypes.c_uint64,
        ctypes.c_uint32,
        POINTER_T(ctypes.c_uint64),
...
struct_EFI_LOADED_IMAGE_PROTOCOL._functions_.append(
    ("Unload", ["ctypes.c_uint64", "POINTER_T(None)"])
)
...
__all__ = [
    ...
    "EFI_INTERFACE_TYPE",
    "EFI_INTERFACE_TYPE__enumvalues",
    "EFI_IP_ADDRESS",
    "EFI_IPv4_ADDRESS",
    "EFI_IPv6_ADDRESS",
    "EFI_KEY",
    ...
    "EFI_LOCATE_SEARCH_TYPE__enumvalues",
    "EFI_MAC_ADDRESS",
    "EFI_MEMORY_DESCRIPTOR",
    "EFI_MEMORY_TYPE",
    "EFI_MEMORY_TYPE__enumvalues",
    "EFI_NARROW_GLYPH",
    ...
    "PEFI_BOOT_KEY_DATA",
    "PEFI_BOOT_SERVICES",
    "PEFI_CAPSULE_BLOCK_DESCRIPTOR",
    "PEFI_CAPSULE_HEADER",
    "PEFI_CAPSULE_TABLE",
    "PEFI_CONFIGURATION_TABLE",
    "PEFI_DEVICE_PATH_PROTOCOL",
    "PEFI_HII_DATE",
    "PEFI_HII_KEYBOARD_LAYOUT",
    "PEFI_HII_KEYBOARD_PACKAGE_HDR",
    "PEFI_HII_PACKAGE_HEADER",
    "PEFI_HII_PACKAGE_LIST_HEADER",
    "PEFI_HII_REF",
    "PEFI_HII_STRING_BLOCK",
    "PEFI_HII_TIME",
    "PEFI_IFR_TYPE_VALUE",
    "PEFI_INPUT_KEY",
    "PEFI_IP_ADDRESS",
    ...
    "PEFI_PARTITION_TABLE_HEADER",
    "PEFI_RUNTIME_SERVICES",
    "PEFI_SIMPLE_TEXT_OUTPUT_MODE",
    "PEFI_SYSTEM_TABLE",
    "PEFI_TABLE_HEADER",
    "PEFI_TIME",
    "PEFI_TIME_CAPABILITIES",
    "PEFI_VARIABLE_AUTHENTICATION",
    "PEFI_VARIABLE_AUTHENTICATION_2",
    "PEFI_WIDE_GLYPH",
    "PEFI_LOADED_IMAGE_PROTOCOL",
    "PGUID",
    "PMINMAXSTEP_DATA",
    "PWIN_CERTIFICATE",
    "PWIN_CERTIFICATE_UEFI_GUID",
    "PXE_BOOL",
    "PXE_CDB",
    "PXE_CONTROL",
    "PXE_CPB_FILL_HEADER",
    ...
    "PXE_UNDI",
    "PXE_VOID",
    "P_EFI_GLYPH_GIBT_END_BLOCK",
    "P_EFI_HII_AIBT_CLEAR_IMAGES_BLOCK",
    "P_EFI_HII_AIBT_DUPLICATE_BLOCK",
    "P_EFI_HII_AIBT_EXT1_BLOCK",
    "P_EFI_HII_AIBT_EXT2_BLOCK",
    "P_EFI_HII_AIBT_EXT4_BLOCK",
    "P_EFI_HII_AIBT_OVERLAY_IMAGES_BLOCK",
    "P_EFI_HII_AIBT_RESTORE_SCRN_BLOCK",
    "P_EFI_HII_AIBT_SKIP1_BLOCK",
    "P_EFI_HII_AIBT_SKIP2_BLOCK",
    "P_EFI_HII_ANIMATION_BLOCK",
    "P_EFI_HII_ANIMATION_CELL",
    "P_EFI_HII_ANIMATION_PACKAGE_HDR",
    "P_EFI_HII_DEVICE_PATH_PACKAGE_HDR",
    "P_EFI_HII_FONT_PACKAGE_HDR",
    "P_EFI_HII_FORM_PACKAGE_HDR",
    "P_EFI_HII_GIBT_DEFAULTS_BLOCK",
    "P_EFI_HII_GIBT_DUPLICATE_BLOCK",
    "P_EFI_HII_GIBT_EXT1_BLOCK",
    "P_EFI_HII_GIBT_EXT2_BLOCK",
    "P_EFI_HII_GIBT_EXT4_BLOCK",
    ...
    "P_EFI_HII_GIBT_SKIP1_BLOCK",
    "P_EFI_HII_GIBT_SKIP2_BLOCK",
    "P_EFI_HII_GLYPH_BLOCK",
    "P_EFI_HII_GLYPH_INFO",
    "P_EFI_HII_GUID_PACKAGE_HDR",
    "P_EFI_HII_IIBT_DUPLICATE_BLOCK",
    "P_EFI_HII_IIBT_END_BLOCK",
    "P_EFI_HII_IIBT_EXT1_BLOCK",
    "P_EFI_HII_IIBT_EXT2_BLOCK",
    "P_EFI_HII_IIBT_EXT4_BLOCK",
    ...
    "P_EFI_HII_IIBT_JPEG_BLOCK",
    "P_EFI_HII_IIBT_SKIP1_BLOCK",
    "P_EFI_HII_IIBT_SKIP2_BLOCK",
    "P_EFI_HII_IMAGE_BLOCK",
    "P_EFI_HII_IMAGE_PACKAGE_HDR",
    "P_EFI_HII_IMAGE_PALETTE_INFO",
    "P_EFI_HII_IMAGE_PALETTE_INFO_HEADER",
    "P_EFI_HII_RGB_PIXEL",
    "P_EFI_HII_SIBT_DUPLICATE_BLOCK",
    "P_EFI_HII_SIBT_END_BLOCK",
    "P_EFI_HII_SIBT_EXT1_BLOCK",
    "P_EFI_HII_SIBT_EXT2_BLOCK",
    "P_EFI_HII_SIBT_EXT4_BLOCK",
    "P_EFI_HII_SIBT_FONT_BLOCK",
    "P_EFI_HII_SIBT_SKIP1_BLOCK",
    "P_EFI_HII_SIBT_SKIP2_BLOCK",
    ...
    "P_EFI_HII_STRING_PACKAGE_HDR",
    "P_EFI_IFR_ACTION",
    "P_EFI_IFR_ACTION_1",
    "P_EFI_IFR_ADD",
    "P_EFI_IFR_AND",
    "P_EFI_IFR_ANIMATION",
    "P_EFI_IFR_BITWISE_AND",
    "P_EFI_IFR_BITWISE_NOT",
    "P_EFI_IFR_BITWISE_OR",
    "P_EFI_IFR_CATENATE",
    "P_EFI_IFR_CHECKBOX",
    "P_EFI_IFR_CONDITIONAL",
    "P_EFI_IFR_DATE",
    "P_EFI_IFR_DEFAULT",
    "P_EFI_IFR_DEFAULTSTORE",
    "P_EFI_IFR_DEFAULT_2",
    "P_EFI_IFR_DISABLE_IF",
    "P_EFI_IFR_DIVIDE",
    "P_EFI_IFR_DUP",
    "P_EFI_IFR_END",
    "P_EFI_IFR_EQUAL",
    "P_EFI_IFR_EQ_ID_ID",
    "P_EFI_IFR_EQ_ID_VAL",
    "P_EFI_IFR_EQ_ID_VAL_LIST",
    "P_EFI_IFR_FALSE",
    "P_EFI_IFR_FIND",
    "P_EFI_IFR_FORM",
    "P_EFI_IFR_FORM_MAP",
    "P_EFI_IFR_FORM_MAP_METHOD",
    "P_EFI_IFR_FORM_SET",
    "P_EFI_IFR_GET",
    "P_EFI_IFR_GRAY_OUT_IF",
    "P_EFI_IFR_GREATER_EQUAL",
    "P_EFI_IFR_GREATER_THAN",
    "P_EFI_IFR_GUID",
    "P_EFI_IFR_IMAGE",
    "P_EFI_IFR_INCONSISTENT_IF",
    "P_EFI_IFR_LENGTH",
    "P_EFI_IFR_LESS_EQUAL",
    "P_EFI_IFR_LESS_THAN",
    "P_EFI_IFR_LOCKED",
    "P_EFI_IFR_MAP",
    "P_EFI_IFR_MATCH",
    ...
    "P_EFI_IFR_NOT",
    "P_EFI_IFR_NOT_EQUAL",
    "P_EFI_IFR_NO_SUBMIT_IF",
    "P_EFI_IFR_NUMERIC",
    "P_EFI_IFR_ONE",
    "P_EFI_IFR_ONES",
    "P_EFI_IFR_ONE_OF",
    "P_EFI_IFR_ONE_OF_OPTION",
    "P_EFI_IFR_OP_HEADER",
    "P_EFI_IFR_OR",
    "P_EFI_IFR_ORDERED_LIST",
    "P_EFI_IFR_PASSWORD",
    "P_EFI_IFR_QUESTION_HEADER",
    "P_EFI_IFR_QUESTION_REF1",
    "P_EFI_IFR_QUESTION_REF2",
    "P_EFI_IFR_QUESTION_REF3",
    "P_EFI_IFR_QUESTION_REF3_2",
    "P_EFI_IFR_QUESTION_REF3_3",
    "P_EFI_IFR_READ",
    "P_EFI_IFR_REF",
    "P_EFI_IFR_REF2",
    "P_EFI_IFR_REF3",
    ...
    "P_EFI_IFR_REF5",
    "P_EFI_IFR_REFRESH",
    "P_EFI_IFR_REFRESH_ID",
    "P_EFI_IFR_RESET_BUTTON",
    "P_EFI_IFR_RULE",
    "P_EFI_IFR_RULE_REF",
    "P_EFI_IFR_SECURITY",
    "P_EFI_IFR_SET",
    "P_EFI_IFR_SHIFT_LEFT",
    "P_EFI_IFR_SHIFT_RIGHT",
    "P_EFI_IFR_SPAN",
    "P_EFI_IFR_STATEMENT_HEADER",
    "P_EFI_IFR_STRING",
    "P_EFI_IFR_STRING_REF1",
    "P_EFI_IFR_STRING_REF2",
    "P_EFI_IFR_SUBTITLE",
    "P_EFI_IFR_SUBTRACT",
    "P_EFI_IFR_SUPPRESS_IF",
    "P_EFI_IFR_TEXT",
    "P_EFI_IFR_THIS",
    "P_EFI_IFR_TIME",
    "P_EFI_IFR_TOKEN",
    "P_EFI_IFR_TO_BOOLEAN",
    "P_EFI_IFR_TO_LOWER",
    "P_EFI_IFR_TO_STRING",
    "P_EFI_IFR_TO_UINT",
    "P_EFI_IFR_TO_UPPER",
    ...
    "P_EFI_IFR_VALUE",
    "P_EFI_IFR_VARSTORE",
    "P_EFI_IFR_VARSTORE_DEVICE",
    "P_EFI_IFR_VARSTORE_EFI",
    "P_EFI_IFR_VARSTORE_NAME_VALUE",
    "P_EFI_IFR_VERSION",
    "P_EFI_IFR_WARNING_IF",
    "P_EFI_IFR_WRITE",
    "P_EFI_IFR_ZERO",
    "P_EFI_SIMPLE_TEXT_INPUT_PROTOCOL",
    "P_EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL",
    "P_struct_113",
    "P_struct_121",
    "P_struct_124",
    "P_struct_230",
    ...
    "Ppxe_device",
    "Ps_pxe_cdb",
    "Ps_pxe_cpb_fill_header",
    "Ps_pxe_cpb_fill_header_fragmented",
    "Ps_pxe_cpb_initialize",
    "Ps_pxe_cpb_mcast_ip_to_mac",
    "Ps_pxe_cpb_nvdata_sparse",
    "Ps_pxe_cpb_receive",
    "Ps_pxe_cpb_receive_filters",
    "Ps_pxe_cpb_start_30",
    "Ps_pxe_cpb_start_31",
    "Ps_pxe_cpb_station_address",
    "Ps_pxe_cpb_transmit",
    "Ps_pxe_cpb_transmit_fragments",
    "Ps_pxe_db_get_init_info",
    "Ps_pxe_db_get_status",
    "Ps_pxe_db_initialize",
    "Ps_pxe_db_mcast_ip_to_mac",
    "Ps_pxe_db_nvdata",
    "Ps_pxe_db_receive",
    "Ps_pxe_db_receive_filters",
    "Ps_pxe_db_statistics",
    "Ps_pxe_dpb_station_address",
    "Ps_pxe_hw_undi",
    "Ps_pxe_pcc_config_info",
    "Ps_pxe_pci_config_info",
    "Ps_pxe_sw_undi",
    "Pu_pxe_cpb_nvdata_bulk",
    "Pu_pxe_db_get_config_info",
    "Pu_pxe_ip_addr",
    "Pu_pxe_undi",
    "RETURN_STATUS",
    "TimerCancel",
    ...
    "s_pxe_sw_undi",
    "struct_EFI_BOOT_SERVICES",
    "struct_EFI_CAPSULE_BLOCK_DESCRIPTOR",
    "struct_EFI_CAPSULE_HEADER",
    "struct_EFI_CAPSULE_TABLE",
    "struct_EFI_CONFIGURATION_TABLE",
    "struct_EFI_DEVICE_PATH_PROTOCOL",
    "struct_EFI_HII_DATE",
    "struct_EFI_HII_KEYBOARD_LAYOUT",
    "struct_EFI_HII_KEYBOARD_PACKAGE_HDR",
    "struct_EFI_HII_PACKAGE_HEADER",
    "struct_EFI_HII_PACKAGE_LIST_HEADER",
    "struct_EFI_HII_REF",
    "struct_EFI_HII_STRING_BLOCK",
    "struct_EFI_HII_TIME",
    "struct_EFI_INPUT_KEY",
    "struct_EFI_IPv4_ADDRESS",
    "struct_EFI_IPv6_ADDRESS",
    "struct_EFI_KEY_DESCRIPTOR",
    "struct_EFI_KEY_OPTION",
    "struct_EFI_MAC_ADDRESS",
    "struct_EFI_MEMORY_DESCRIPTOR",
    "struct_EFI_NARROW_GLYPH",
    "struct_EFI_OPEN_PROTOCOL_INFORMATION_ENTRY",
    "struct_EFI_PARTITION_ENTRY",
    "struct_EFI_PARTITION_TABLE_HEADER",
    "struct_EFI_RUNTIME_SERVICES",
    "struct_EFI_LOADED_IMAGE_PROTOCOL",
    "struct_EFI_SIMPLE_TEXT_OUTPUT_MODE",
    "struct_EFI_SYSTEM_TABLE",
    "struct_EFI_TABLE_HEADER",
    "struct_EFI_TIME",
    "struct_EFI_TIME_CAPABILITIES",
    "struct_EFI_VARIABLE_AUTHENTICATION",
    "struct_EFI_VARIABLE_AUTHENTICATION_2",
    "struct_EFI_WIDE_GLYPH",
    "struct_GUID",
    "struct_WIN_CERTIFICATE",
    ...
    "struct__EFI_HII_GIBT_SKIP2_BLOCK",
    "struct__EFI_HII_GLYPH_BLOCK",
    "struct__EFI_HII_GLYPH_INFO",
    "struct__EFI_HII_GUID_PACKAGE_HDR",
    ...
    "struct__EFI_HII_IIBT_SKIP2_BLOCK",
    "struct__EFI_HII_IMAGE_BLOCK",
    ...
    "struct__EFI_HII_SIBT_STRING_UCS2_FONT_BLOCK",
    "struct__EFI_HII_SIMPLE_FONT_PACKAGE_HDR",
    "struct__EFI_HII_STRING_PACKAGE_HDR",
    "struct__EFI_IFR_ACTION",
    "struct__EFI_IFR_ACTION_1",
    "struct__EFI_IFR_ADD",
    "struct__EFI_IFR_AND",
    "struct__EFI_IFR_ANIMATION",
    "struct__EFI_IFR_BITWISE_AND",
    "struct__EFI_IFR_BITWISE_NOT",
    "struct__EFI_IFR_BITWISE_OR",
    "struct__EFI_IFR_CATENATE",
    "struct__EFI_IFR_CHECKBOX",
    "struct__EFI_IFR_CONDITIONAL",
    "struct__EFI_IFR_DATE",
    "struct__EFI_IFR_DEFAULT",
    "struct__EFI_IFR_DEFAULTSTORE",
    "struct__EFI_IFR_DEFAULT_2",
    "struct__EFI_IFR_DISABLE_IF",
    "struct__EFI_IFR_DIVIDE",
    "struct__EFI_IFR_DUP",
    "struct__EFI_IFR_END",
    "struct__EFI_IFR_EQUAL",
    "struct__EFI_IFR_EQ_ID_ID",
    "struct__EFI_IFR_EQ_ID_VAL",
    "struct__EFI_IFR_EQ_ID_VAL_LIST",
    "struct__EFI_IFR_FALSE",
    "struct__EFI_IFR_FIND",
    "struct__EFI_IFR_FORM",
    "struct__EFI_IFR_FORM_MAP",
    "struct__EFI_IFR_FORM_MAP_METHOD",
    "struct__EFI_IFR_FORM_SET",
    "struct__EFI_IFR_GET",
    "struct__EFI_IFR_GRAY_OUT_IF",
    "struct__EFI_IFR_GREATER_EQUAL",
    "struct__EFI_IFR_GREATER_THAN",
    "struct__EFI_IFR_GUID",
    "struct__EFI_IFR_IMAGE",
    "struct__EFI_IFR_INCONSISTENT_IF",
    "struct__EFI_IFR_LENGTH",
    "struct__EFI_IFR_LESS_EQUAL",
    "struct__EFI_IFR_LESS_THAN",
    "struct__EFI_IFR_LOCKED",
    "struct__EFI_IFR_MAP",
    "struct__EFI_IFR_MATCH",
    "struct__EFI_IFR_MID",
    "struct__EFI_IFR_MODAL_TAG",
    "struct__EFI_IFR_MODULO",
    "struct__EFI_IFR_MULTIPLY",
    "struct__EFI_IFR_NOT",
    "struct__EFI_IFR_NOT_EQUAL",
    "struct__EFI_IFR_NO_SUBMIT_IF",
    "struct__EFI_IFR_NUMERIC",
    "struct__EFI_IFR_ONE",
    "struct__EFI_IFR_ONES",
    "struct__EFI_IFR_ONE_OF",
    "struct__EFI_IFR_ONE_OF_OPTION",
    "struct__EFI_IFR_OP_HEADER",
    "struct__EFI_IFR_OR",
    "struct__EFI_IFR_ORDERED_LIST",
    "struct__EFI_IFR_PASSWORD",
    "struct__EFI_IFR_QUESTION_HEADER",
    "struct__EFI_IFR_QUESTION_REF1",
    "struct__EFI_IFR_QUESTION_REF2",
    "struct__EFI_IFR_QUESTION_REF3",
    "struct__EFI_IFR_QUESTION_REF3_2",
    "struct__EFI_IFR_QUESTION_REF3_3",
    "struct__EFI_IFR_READ",
    "struct__EFI_IFR_REF",
    "struct__EFI_IFR_REF2",
    "struct__EFI_IFR_REF3",
    "struct__EFI_IFR_REF4",
    "struct__EFI_IFR_REF5",
    "struct__EFI_IFR_REFRESH",
    "struct__EFI_IFR_REFRESH_ID",
    "struct__EFI_IFR_RESET_BUTTON",
    "struct__EFI_IFR_RULE",
    "struct__EFI_IFR_RULE_REF",
    "struct__EFI_IFR_SECURITY",
    "struct__EFI_IFR_SET",
    "struct__EFI_IFR_SHIFT_LEFT",
    "struct__EFI_IFR_SHIFT_RIGHT",
    "struct__EFI_IFR_SPAN",
    "struct__EFI_IFR_STATEMENT_HEADER",
    "struct__EFI_IFR_STRING",
    "struct__EFI_IFR_STRING_REF1",
    "struct__EFI_IFR_STRING_REF2",
    "struct__EFI_IFR_SUBTITLE",
    "struct__EFI_IFR_SUBTRACT",
    "struct__EFI_IFR_SUPPRESS_IF",
    "struct__EFI_IFR_TEXT",
    "struct__EFI_IFR_THIS",
    "struct__EFI_IFR_TIME",
    "struct__EFI_IFR_TOKEN",
    "struct__EFI_IFR_TO_BOOLEAN",
    "struct__EFI_IFR_TO_LOWER",
    "struct__EFI_IFR_TO_STRING",
    "struct__EFI_IFR_TO_UINT",
    "struct__EFI_IFR_TO_UPPER",
    "struct__EFI_IFR_TRUE",
    "struct__EFI_IFR_UINT16",
    "struct__EFI_IFR_UINT32",
    "struct__EFI_IFR_UINT64",
    "struct__EFI_IFR_UINT8",
    "struct__EFI_IFR_UNDEFINED",
    "struct__EFI_IFR_VALUE",
    "struct__EFI_IFR_VARSTORE",
    "struct__EFI_IFR_VARSTORE_DEVICE",
    "struct__EFI_IFR_VARSTORE_EFI",
    "struct__EFI_IFR_VARSTORE_NAME_VALUE",
    "struct__EFI_IFR_VERSION",
    "struct__EFI_IFR_WARNING_IF",
    "struct__EFI_IFR_WRITE",
    "struct__EFI_IFR_ZERO",
    "struct__EFI_SIMPLE_TEXT_INPUT_PROTOCOL",
    "struct__EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL",
    "struct__struct_113",
    "struct__struct_121",
    ...
    "struct_s_pxe_cpb_fill_header_fragmented",
    "struct_s_pxe_cpb_initialize",
    "struct_s_pxe_cpb_mcast_ip_to_mac",
    "struct_s_pxe_cpb_nvdata_sparse",
    "struct_s_pxe_cpb_receive",
    "struct_s_pxe_cpb_receive_filters",
    "struct_s_pxe_cpb_start_30",
    "struct_s_pxe_cpb_start_31",
    "struct_s_pxe_cpb_station_address",
    "struct_s_pxe_cpb_transmit",
    "struct_s_pxe_cpb_transmit_fragments",
    "struct_s_pxe_db_get_init_info",
    "struct_s_pxe_db_get_status",
    "struct_s_pxe_db_initialize",
    "struct_s_pxe_db_mcast_ip_to_mac",
    "struct_s_pxe_db_nvdata",
    "struct_s_pxe_db_receive",
    "struct_s_pxe_db_receive_filters",
    "struct_s_pxe_db_statistics",
    "struct_s_pxe_dpb_station_address",
    "struct_s_pxe_hw_undi",
    "struct_s_pxe_pcc_config_info",
    "struct_s_pxe_pci_config_info",
    "struct_s_pxe_sw_undi",
    ...
    "undefined4",
    "undefined8",
    "union_EFI_BOOT_KEY_DATA",
    "union_EFI_IFR_TYPE_VALUE",
    "union_EFI_IP_ADDRESS",
    "union_MINMAXSTEP_DATA",
    "union__union_101",
    "union__union_114",
    "union__union_117",
    "union__union_202",
    ...
    "union__union_99",
    "union_pxe_device",
    "union_u_pxe_cpb_nvdata_bulk",
    "union_u_pxe_db_get_config_info",
    "union_u_pxe_ip_addr",
    "union_u_pxe_undi",
    "ushort",
    "word",

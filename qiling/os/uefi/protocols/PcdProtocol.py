...
PCD_PROTOCOL_SET_EX_POINTER = FUNCPTR(
    EFI_STATUS, PTR(EFI_GUID), UINTN, PTR(UINTN), PTR(VOID)
)
PCD_PROTOCOL_SET_EX_BOOLEAN = FUNCPTR(EFI_STATUS, PTR(EFI_GUID), UINTN, BOOLEAN)
PCD_PROTOCOL_CALLBACK_ONSET = FUNCPTR(
    EFI_STATUS, PTR(EFI_GUID), UINTN, PCD_PROTOCOL_CALLBACK
)
PCD_PROTOCOL_CANCEL_CALLBACK = FUNCPTR(
    EFI_STATUS, PTR(EFI_GUID), UINTN, PCD_PROTOCOL_CALLBACK
)
...
@dxeapi(params={"SkuId": UINT})
def hook_SetSku(ql, address, params):
    pass


@dxeapi(params={"TokenNumber": UINT})
...
@dxeapi(params={"Guid": GUID, "TokenNumber": UINT})
...
@dxeapi(params={"TokenNumber": UINT, "Value": INT})
...
@dxeapi(params={"TokenNumber": UINT, "SizeOfValue": POINTER, "Buffer": POINTER})
...
@dxeapi(params={"Guid": GUID, "TokenNumber": UINT, "Value": INT})
...
@dxeapi(params={"Guid": GUID, "TokenNumber": UINT, "CallBackFunction": POINTER})
...
@dxeapi(params={"Guid": GUID, "TokenNumber": POINTER})
def hook_GetNextToken(ql, address, params):
    pass


@dxeapi(params={"Guid": POINTER})

...
struct__EFI_IFR_ONE_OF_OPTION._pack_ = True  # source:False
struct__EFI_IFR_ONE_OF_OPTION._fields_ = [
    ("Header", EFI_IFR_OP_HEADER),
...
struct__EFI_IFR_STRING._pack_ = True  # source:False
struct__EFI_IFR_STRING._fields_ = [
    ("Header", EFI_IFR_OP_HEADER),
    ("Question", EFI_IFR_QUESTION_HEADER),
...
struct__EFI_IFR_UNDEFINED._pack_ = True  # source:False
struct__EFI_IFR_UNDEFINED._fields_ = [
    ("Header", EFI_IFR_OP_HEADER),
]
...
struct_s_pxe_db_receive._pack_ = True  # source:False
struct_s_pxe_db_receive._fields_ = [
    ("SrcAddr", ctypes.c_ubyte * 32),
    ("DestAddr", ctypes.c_ubyte * 32),
    ("FrameLen", ctypes.c_uint32),
    ("Protocol", ctypes.c_uint16),

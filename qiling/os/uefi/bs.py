...
@dxeapi(params={"NewTpl": ULONGLONG})  # EFI_TPL
...
@dxeapi(params={"OldTpl": ULONGLONG})  # EFI_TPL
...
@dxeapi(params={"Event": POINTER})  # EFI_EVENT
...
@dxeapi(params={"ImageHandle": POINTER})  # EFI_HANDLE
def hook_UnloadImage(ql: Qiling, address: int, params):
    return EFI_SUCCESS


@dxeapi(
    params={"ImageHandle": POINTER, "MapKey": ULONGLONG}  # EFI_HANDLE  # UINTN
)
...
@dxeapi(params={"Count": POINTER})  # PTR(UINT64)
...
@dxeapi(params={"Microseconds": ULONGLONG})  # UINTN
    ...
    descriptor = {
        ...
        "fields": (
            ...
            (
                ...
                hook_UninstallMultipleProtocolInterfaces,
            ),

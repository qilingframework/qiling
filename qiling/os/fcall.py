...
class QlFunctionCall:
    def __init__(
        self, ql: Qiling, cc: QlCC, accessors: Mapping[int, Accessor] = {}
    ) -> None:
    ...
    @staticmethod
    def __get_typed_args(
        proto: Mapping[str, Any], args: Mapping[str, Any]
    ) -> Iterable[TypedArg]:
    ...
    def call(
        ...
        hook_onenter: Optional[OnEnterHook],
        hook_onexit: Optional[OnExitHook],
        passthru: bool,
    ) -> Tuple[Iterable[TypedArg], int, int]:

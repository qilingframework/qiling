...
COMM_PAGE_THIS_VERSION = (
    13  # in ver 13, _COMM_PAGE_NT_SHIFT defaults to 0 (was 32)
)

COMM_PAGE_CPU_CAPABILITIES = (
...
COMM_PAGE_SCHED_GEN = (
    0x028  # uint32_t scheduler generation number (count of pre-emptions) */
)

...
# );
@winsdkapi(cc=CDECL, dllname=dllname, funcname="RtlGetVersion", defparams={"lpVersionInformation": POINTER})
...
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="ZwSetInformationThread", defparams={"ThreadHandle": HANDLE,
...
#   HANDLE Handle
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="ZwClose", defparams={"Handle": HANDLE})

...
#  LONG          Value
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="InterlockedExchange", defparams={"Target": POINTER, "Value": UINT})
...
#  LONG volatile *Target,
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="InterlockedIncrement", defparams={"Target": POINTER})
...
#  LONG volatile *Target,
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="InterlockedDecrement", defparams={"Target": POINTER})
...
#   BYTE      Condition
# );
@winsdkapi(cc=STDCALL, dllname=dllname, funcname="VerSetConditionMask",
           defparams={"ConditionMask": ULONGLONG, "TypeMask": DWORD, "Condition": BYTE})

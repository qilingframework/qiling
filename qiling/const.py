...
QL_ARCH_ALL     = [QL_ARCH.X86, QL_ARCH.X8664, QL_ARCH.ARM, QL_ARCH.ARM_THUMB, QL_ARCH.ARM64, QL_ARCH.MIPS, QL_ARCH.A8086, QL_ARCH.SPARC]
QL_ARCH_16BIT   = [QL_ARCH.A8086]
QL_ARCH_32BIT   = [QL_ARCH.ARM, QL_ARCH.ARM_THUMB, QL_ARCH.MIPS, QL_ARCH.X86, QL_ARCH.SPARC]

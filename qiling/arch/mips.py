...
from unicorn import Uc, UC_ARCH_MIPS, UC_MODE_MIPS32, UC_MODE_BIG_ENDIAN, UC_MODE_LITTLE_ENDIAN, UC_MODE_AFL
...
class QlArchMIPS(QlArch):
    ...
    def get_init_uc(self) -> Uc:
        ...
        mode = UC_MODE_MIPS32 + endian

        if self.ql.afl:
            mode &= UC_MODE_AFL

        return Uc(UC_ARCH_MIPS, mode)

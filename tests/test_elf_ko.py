...
class ELF_KO_Test(unittest.TestCase):
    def test_demigod_m0hamed_x86(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x86_linux/kernel/m0hamed_rootkit.ko"],
        ...
        try:
            ...
            sys.exit(-1)
        self.assertEqual(
            "DONT YOU EVER TRY TO READ THIS FILE OR I AM GOING TO DESTROY YOUR MOST SECRET DREAMS",
            self.set_api_myprintk,
        )
        del ql
    ...
    def test_demigod_hello_x8664(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x8664_linux/kernel/hello.ko"],

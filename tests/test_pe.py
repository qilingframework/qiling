...
class PETest(unittest.TestCase):
    ...
    def test_pe_win_x86_uselessdisk(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/UselessDisk.bin"],
            "../examples/rootfs/x86_windows",
    ...
    def test_pe_win_x86_gandcrab(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/GandCrab502.bin"],
            "../examples/rootfs/x86_windows",
            verbose=QL_VERBOSE.DEBUG,
            profile="profiles/windows_gandcrab_admin.ql",
        )
        default_user = ql.os.profile["USER"]["username"]
        default_computer = ql.os.profile["SYSTEM"]["computername"]

        ql.hook_address(
            stop, 0x40860F, user_data=(default_user, default_computer)
        )
        ...
        ql = Qiling(
            ...
            "../examples/rootfs/x86_windows",
            verbose=QL_VERBOSE.DEBUG,
            profile="profiles/windows_gandcrab_user.ql",
        )
        ...
        ql = Qiling(
            ...
            "../examples/rootfs/x86_windows",
            verbose=QL_VERBOSE.DEBUG,
            profile="profiles/windows_gandcrab_russian_keyboard.ql",
        )
    ...
    def test_pe_win_x86_multithread(self):
        ...
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/MultiThread.exe"],
            "../examples/rootfs/x86_windows",
        )
    ...
    def test_pe_win_x86_tls(self):
        ql = Qiling(
            ["../examples/rootfs/x8664_windows/bin/x8664_tls.exe"],
            "../examples/rootfs/x8664_windows",
        )
        ql.run()
        del ql
    ...
    def test_pe_win_x86_regdemo(self):
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/RegDemo.exe"],
            "../examples/rootfs/x86_windows",
        )
        ql.run()
        del ql
    ...
    def test_pe_win_x8664_fls(self):
        ql = Qiling(
            ["../examples/rootfs/x8664_windows/bin/Fls.exe"],
            "../examples/rootfs/x8664_windows",
            verbose=QL_VERBOSE.DEFAULT,
        )
        ql.run()
    ...
    def test_pe_win_x86_return_from_main_stackpointer(self):
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/return_main.exe"],
            "../examples/rootfs/x86_windows",
            libcache=True,
    ...
    def test_pe_win_x8664_return_from_main_stackpointer(self):
        ql = Qiling(
            ["../examples/rootfs/x8664_windows/bin/x8664_return_main.exe"],
            "../examples/rootfs/x8664_windows",
            libcache=True,
            stop_on_stackpointer=True,
        )
    ...
    def test_pe_win_al_khaser(self):
        if "QL_FAST_TEST" in os.environ:
            return
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/al-khaser.bin"],
            "../examples/rootfs/x86_windows",
        )
    ...
    def test_pe_win_x86_argv(self):
        def check_print(ql: Qiling, address: int, params):
            ...
            fargs = [
                ql.unpack(
                    ql.mem.read(arglist + i * ql.pointersize, ql.pointersize)
                )
        ...
        ql = Qiling(
            ["../examples/rootfs/x86_windows/bin/argv.exe"],
            "../examples/rootfs/x86_windows",
        )
    ...
    def test_pe_win_x86_crackme(self):
        ...
        our_sandbox(
            ["../examples/rootfs/x86_windows/bin/Easy_CrackMe.exe"],
            "../examples/rootfs/x86_windows",
        )
    ...
    def test_pe_win_x86_cmdln(self):
        ql = Qiling(
            [
                "../examples/rootfs/x86_windows/bin/cmdln32.exe",
                "arg1",
                "arg2 with spaces",
            ],
            "../examples/rootfs/x86_windows",
    ...
    def test_pe_win_x8664_cmdln(self):
        ql = Qiling(
            [
                "../examples/rootfs/x8664_windows/bin/cmdln64.exe",
                "arg1",
                "arg2 with spaces",
            ],
            "../examples/rootfs/x8664_windows",
    ...
    class TestCache(QlPeCache):
        ...
        def restore(self, path, address):
            ...
            self.testcase.assertTrue(
                entry is not None
            )  # Check that it loaded a cache entry

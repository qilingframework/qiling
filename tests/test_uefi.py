...
class Test_UEFI(unittest.TestCase):
    def test_x8664_uefi_santizier(self):
        ...
        def enable_sanitized_heap(ql, fault_rate=0):
            ...
            ql.os.heap.uaf_handler = lambda *args: my_abort(
    ...
    def test_x8664_uefi(self):
        ...
        if __name__ == "__main__":
            with open(
                "../examples/rootfs/x8664_efi/rom2_nvar.pickel", "rb"
            ) as f:
                env = pickle.load(f)
            ql = Qiling(
            ...
            ql.set_api(
                "RegisterProtocolNotify", force_notify_RegisterProtocolNotify
            )

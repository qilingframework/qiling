...
if [ ! -d examples/rootfs/x8664_macos/System/Library ]; then
   mkdir -p examples/rootfs/x8664_macos/System/Library;
fi
wget -O examples/rootfs/x8664_macos/System/Library/kernel.development https://github.com/qilingframework/tests/raw/master/rootfs/x8664_macos/System/Library/Kernels/kernel.development; 

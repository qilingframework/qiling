...
wget -O examples/rootfs/x8664_macos/System/Library/Kernels/kernel.development https://github.com/qilingframework/tests/raw/master/rootfs/x8664_macos/System/Library/Kernels/kernel.development; 

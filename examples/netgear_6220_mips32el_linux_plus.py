...
# -------------------------------------------
#
# Based on netgear_6220_mips32el_linux.py
# I'm going to update this script with all the new tricks as soon I archive them, and I have some spare time!
#
# This file's intension is to provide some examples of more advanced operation done with qiling on this binary.
#
